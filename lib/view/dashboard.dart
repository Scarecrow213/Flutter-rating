...
import 'package:flutterapitut/view/Statistcs.dart';
      ...
      itemCount: list==null?0:list.length,
        ...
        return new Container(
          ...
          child: new GestureDetector(
            ...
            child: new Card(
              child: new ListTile(
                title: new Text(list[i]['student']),
                leading: new Text('${list[i]['rate']}'),
                subtitle: new Text('Subject : ${list[i]['subject']}'),
              ),
            )
            ,
          ),
